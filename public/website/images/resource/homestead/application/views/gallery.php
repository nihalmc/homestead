    	...
    	<div class="auto-container">
        	<div class="row clearfix">
            	...
            	<div class="case-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image">
                        	<img src="<?php echo extr()?>images/gallery/<?php echo $gal->image ?>" alt="" />
                            <div class="overlay-box">
                                <div class="content">
                                  
                                    <a class="lightbox-image" href="<?php echo extr()?>images/gallery/<?php echo $gal->image ?>" title="<?php echo $gal->title ?> " data-fancybox-group="gallery"><span class="icon fa fa-search"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
